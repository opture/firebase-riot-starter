<yoshiko-input>
		...
		<input class="input__field input__field--yoshiko" type="{type}" name="{name}" value="{value}" id="input-11" />
		<label class="input__label input__label--yoshiko" for="input-11">
				<span class="input__label-content input__label-content--yoshiko" data-content={label}>{label}</span>
		</label>
